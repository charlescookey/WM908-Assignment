...
void DrawHelp::drawPlainBackground(GamesEngineeringBase::Window& canvas, int R, int G, int  B) {
...
void DrawHelp::drawImage(GamesEngineeringBase::Window& canvas, GamesEngineeringBase::Image& image, int startX, int startY) {
...
void DrawHelp::drawAlphaImage(GamesEngineeringBase::Window& canvas, GamesEngineeringBase::Image& image, int startX, int startY, int alpha) {
	for (unsigned int i = 0; i < image.width; i++) {
		for (unsigned int j = 0; j < image.height; j++) {
...
void DrawHelp::drawRectangle(GamesEngineeringBase::Window& canvas, Rect rect, int R, int G, int B) {
...
void DrawHelp::drawBorder(GamesEngineeringBase::Window& canvas, Rect rect, int border, int R, int G, int B) {
	int width = static_cast<int>(rect.getWidth());
	int height = static_cast<int>(rect.getHeight());
...
void DrawHelp::drawCircle(GamesEngineeringBase::Window& canvas, Circle circle, int R, int G, int B) {
